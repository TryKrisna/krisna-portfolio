  ...
  return (
    <div id='projects' className='w-full'>
      ...
      <h2 className='w-100 text-center py-4'>Project</h2>
        ...
        <div className='bg-white relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff]'>
